                            ...
                            <Row>
                                ...
                                <Col lg={5}>
                                    <Row>
                                        ...
                                        <Col lg={8} xs={11}>
                                            <input type="text" className={this.state.form_errors["nombre"] ? "form-control is-invalid" : this.state.errors_checked["nombre"] ? "form-control is-valid" : "form-control"} name="nombre" onChange={this.onChange} placeholder="Nombre Feriado" style={{textAlignLast:'center'}} />
                                ...
                                <Col lg={5}>
                                    <Row>
                                        ...
                                        {/* No pude centrarlo, hay un problema con prioridades de css de react */}
                                            <select className={this.state.form_errors["tipo"] ? "form-control is-invalid" : this.state.errors_checked["tipo"] ? "form-control is-valid" : "form-control"}  onChange={this.onChange} name="tipo" style={{textAlignLast:'center',textAlign:'center'}}  >
                            ...
                            <Row>
                                ...
                                <Col lg={5} >
                                    <Row>
                                        ...
                                        <Col lg={8} xs={11}>
                                            <input type="date" onChange={this.onChange} className={this.state.form_errors["inicio"] ? "form-control is-invalid" : this.state.errors_checked["inicio"] ? "form-control is-valid" : "form-control"} name="inicio" />
                                ...
                                <Col lg={5}>
                                    <Row>
                                        ...
                                        <Col lg={8} xs={12}>
                                            <input type="date" onChange={this.onChange} className={this.state.form_errors["fin"] ? "form-control is-invalid" : this.state.errors_checked["fin"] ? "form-control" : "form-control"} name="fin"  />
